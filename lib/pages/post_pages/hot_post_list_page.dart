...
class HotPostListPage extends StatefulWidget {
  const HotPostListPage({Key? key}) : super(key: key);

  @override
  State<HotPostListPage> createState() => _HotPostListPageState();
}

class _HotPostListPageState extends State<HotPostListPage> with AutomaticKeepAliveClientMixin {
  ...
  void _loadData(int page) async {
    var res = await Api.getHotPosts(page: page);
    if (res['code'] == 0) {
