...
class GoodPostListPage extends StatefulWidget {
  const GoodPostListPage({Key? key}) : super(key: key);

  @override
  State<GoodPostListPage> createState() => _GoodPostListPageState();
}

class _GoodPostListPageState extends State<GoodPostListPage> with AutomaticKeepAliveClientMixin {
