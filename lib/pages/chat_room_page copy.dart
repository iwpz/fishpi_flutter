...
//     super.initState();
//     _loadMessages();
//     if (DataManager.chatRoomOnLineInfo != {}) {
//       setState(() {
...
//   void _loadMessages([bool isHistory = false]) async {
//     if (isGettingOldMessage) {
//       return;
//     }
//     isGettingOldMessage = true;
//     var res = await Api.getChatHistoryMessage(page: historyMessagePage);
//     historyMessagePage++;
//     if (res['code'] == 0) {
//       List msgList = res['data'];
//       for (int i = msgList.length - 1; i >= 0; i--) {
//         var msg = msgList[i];
//         msg['type'] = 'msg';
//         _addMessageToUI(msg, isHistory);
//       }
//     }
//     isGettingOldMessage = false;
//   }

//   void _addMessageToUI(msg, [bool isBack = false]) {
...
//     if (BlackListManager().isInBlackList(message.metadata!['userName'])) {
//       return Container();
//     }
//     var metals = {};
